...
public:
    ...
    RightUpperLeg_RightLowerLeg_Joint=point(0,-0.125,0.075);
    ...
    LeftShoulder_LeftUpperArm_Joint=point(0.025,0.075,-0.075);
    LeftUpperArm_LeftLowerArm_Joint=point(0,-0.125,-0.025);
    RightShoulder_RightUpperArm_Joint=point(-0.025,0.075,-0.075);
    RightUpperArm_RightLowerArm_Joint=point(-0.025,0.075,-0.075);
    //std::cout<<"Robot";
    initHip();
    initBust();
    initNeck();
